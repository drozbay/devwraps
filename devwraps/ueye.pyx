...
from .ueyed cimport (
    ...
    UEYE_CAPTURE_STATUS_INFO, is_CaptureStatus, UEYE_CAMERA_LIST,
    is_GetCameraList, UEYE_CAMERA_INFO, IS_USE_DEVICE_ID)
...
cdef class uEye:
    ...
    def get_devices(self):
        ...
        if num <= 0:
            ...
            clist = <UEYE_CAMERA_LIST *>malloc(
                sizeof(unsigned long) + num*sizeof(UEYE_CAMERA_INFO))
            if clist == NULL:
    ...
    def get_capture_status(self):
        cdef int ret
        cdef UEYE_CAPTURE_STATUS_INFO csi
